...
If you are a developer (or an AI agent) looking to understand how the internal proxy, Express server, and CDP web sockets work, or if you want to contribute to the codebase, please refer to our full **[Architecture & Development Guide](ARCHITECTURE.md)**.
